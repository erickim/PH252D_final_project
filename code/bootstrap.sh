...
rscript code/tmle_bootstrap.R bootstrap=TRUE type=\"continuous\" B=150 n=2500 > output/tmle_binary.txt
rscript code/tmle_bootstrap.R bootstrap=TRUE type=\"binary\" B=150 n=2500 > output/tmle_continuous.txt
